...
type ResponsePiezas struct {
	...
	//SubParts          []ResponsePiezas `json:"subparts"`
}
type PartItems struct {
	...
	//SuperSession        []SuperPartItems `json:"superSession"`
...
type SuperPartItems struct {
	...
	PriceBookSelected       bool  `json:"priceBookSelected"`
	SupersessionAvailable   bool  `json:"supersessionAvailable"`
	HistoryAvailable        bool  `json:"historyAvailable"`
	AttachmentAvailable     bool  `json:"attachmentAvailable"`
	AlternateAvailable      bool  `json:"alternateAvailable"`
	PartAttributesAvailable bool  `json:"partAttributesAvailable"`
	KitAvailable            bool  `json:"kitAvailable"`
	IdentifiesAvailable     bool  `json:"identifiesAvailable"`
